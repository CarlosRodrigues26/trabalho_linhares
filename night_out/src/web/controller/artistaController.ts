...
export async function listarArtistas(req: Request, res: Response) {
  try {
...
export async function cadastrarArtista(req: Request, res: Response) {
  try {
...
export const atualizarArtista: RequestHandler = async (req, res) => {
  try {
    const { id } = req.params;
    const dados = req.body;
